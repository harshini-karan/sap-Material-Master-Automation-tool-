"""
Example script: Bulk create materials from CSV file using RFC API
"""
...
def main():
    """Example: Bulk create materials using RFC API"""
    
    print("="*60)
    print("SAP Material Master - Bulk Creation Example (RFC)")
    print("="*60)
    ...
    try:
        # Process materials using RFC method
        print(f"\nProcessing materials from: {input_file}")
        print("Method: RFC API\n")
        
        summary = automation.process_materials(input_file, method='rfc')
